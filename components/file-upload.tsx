...
export function FileUpload({ onAudioLoad, onBackgroundLoad, onOverlayLogoLoad, backgroundImage, overlayLogo, audioFileName, onRemoveBackground, onRemoveOverlayLogo }: FileUploadProps) {
